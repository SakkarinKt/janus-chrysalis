 ...
 * seeds per-agent: agent 1's own actions diverge 0/38 in all three seeds — every joint divergence
 * is agent 0's [the frozen agent]. What the frozen agent's loss can see is its own observation,
